<x-default-layout title="Mon compte">
    ...
    <form action="{{ route('home') }}" method="POST">
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <button type="submit" class="rounded-md bg-green-950 px-3 py-2 text-sm font-semibold hover:text-green-950 text-green-300  shadow-sm hover:bg-green-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Modifier</button>
        </div>
    </form>
</x-default-layout>
